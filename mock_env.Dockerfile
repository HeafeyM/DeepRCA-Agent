...
COPY src/deeprca/detection/ ./src/deeprca/detection/
COPY src/deeprca/agents/ ./src/deeprca/agents/
COPY src/deeprca/graph/ ./src/deeprca/graph/
COPY src/deeprca/api/ ./src/deeprca/api/
